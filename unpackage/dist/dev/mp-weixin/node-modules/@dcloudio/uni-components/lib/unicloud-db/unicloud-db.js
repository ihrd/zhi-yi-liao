...
const _sfc_main = {
  name: "UniClouddb",
  setup(props) {
    const dataListRef = props.ssrKey ? props.getone ? common_vendor.shallowSsrRef(void 0, props.ssrKey) : common_vendor.ssrRef([], props.ssrKey) : props.getone ? common_vendor.shallowSsrRef(void 0, "JZ/9mJwgIEbFy+VRb60Eug==") : common_vendor.ssrRef([], "gMjjBYcZzOpHAcY5LGdY+A==");
  ...
  methods: {
    ...
    add(value, {
      ...
      let db = common_vendor.Bs.database(this.spaceInfo);
      if (action) {
        db = db.action(action);
      }
    ...
    _execRemove(id, action, success, fail, complete, needConfirm, needLoading, loadingTitle) {
      ...
      const db = common_vendor.Bs.database(this.spaceInfo);
...
const Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "D:/Application Program/HBuilderX/plugins/uniapp-cli-vite/node_modules/@dcloudio/uni-components/lib/unicloud-db/unicloud-db.vue"]]);
