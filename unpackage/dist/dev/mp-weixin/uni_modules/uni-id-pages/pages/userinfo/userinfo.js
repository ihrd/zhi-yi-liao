...
const _sfc_main = {
  ...
  methods: {
    ...
    async bindThirdAccount(provider) {
      const uniIdCo2 = common_vendor.Bs.importObject("uni-id-co");
      const bindField = {
        weixin: "wx_openid",
        alipay: "ali_openid",
        apple: "apple_openid",
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-0be2f605"], ["__file", "D:/Development/WeChat/chatKYXF/uni_modules/uni-id-pages/pages/userinfo/userinfo.vue"]]);
